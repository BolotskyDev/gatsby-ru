...
<!-- Базовый шаблон для Gatsby-рецепта:

## Задача для выполнения.
1-2 предложения. Чем короче и конкретнее, тем лучше!

### Предварительные условия
- Системные/версионные требования
- Все необходимое для подготовки задачи
- Включая настройку аккаунтов на других сайтах, наподобие Netlify
- Смотрите правила форматирования в [шаблонах документов](/docs/docs-templates/)

### Указания
Пошаговые указания. Каждый шаг должен быть воспроизводимым и конкретным. Все, что не критично, должно быть опущено. 

#### Живой пример (опционально)
В некоторых случаях живой пример может быть невозможен, в таком случае его тоже можно опустить.
...
Больше примеров в [шаблонах документов](/docs/docs-templates/) из разделa, посвященного вкладам.
-->

Ищете компромисс между [полноразмерными руководствами](/tutorial/) и [документацией](/docs/)? Перед вами кулинарная книга с рецептами по тому, как строить вещи, в стиле Gatsby.
